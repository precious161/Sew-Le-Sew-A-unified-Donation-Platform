...
const Sidebar = ({ isDarkMode }) => {
  ...
  const menuItems = [
    { 
      ...
      icon: isAdmin ? <ShieldAlert size={20}/> : <LayoutDashboard size={20}/>, 
      ...
      <div className="pt-6 border-t border-white/5">
        <div className="flex items-center gap-4 mb-6 p-2">
          ...
          <div className="overflow-hidden text-left">
            <p className="text-sm font-black uppercase truncate text-white leading-tight">
              {user?.FirstName}
            </p>
            <p className="text-[9px] text-[#05CD99] font-black uppercase tracking-[0.15em] mt-1">
