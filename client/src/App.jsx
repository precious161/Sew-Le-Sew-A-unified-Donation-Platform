...
import RegisterIntent from './pages/donations/donor/RegisterIntent'; // FIXED: Added this missing import
      ...
      <AuthProvider>
        <BrowserRouter>
          <Routes>
            ...
            {/* RECIPIENT DONATION ROUTES */}
            <Route path="/donations/recipient/health-info" element={<ProtectedRoute allowedRoles={['Recipient']}><HealthInfo /></ProtectedRoute>} />
            <Route path="/recipient/new-request" element={<ProtectedRoute allowedRoles={['Recipient']}><CreateRequest /></ProtectedRoute>} />
