...
import NotificationHub from '../components/notifications/NotificationHub'; // IMPORTED
      ...
      <main className="flex-1 ml-72 p-10 flex flex-col text-left">
        <header className="flex justify-between items-center mb-12">
          <div className="flex items-center gap-3">
             <div className={`w-2 h-2 rounded-full animate-pulse ${canProceed ? 'bg-blue-400 shadow-[0_0_10px_rgba(96,165,250,0.8)]' : 'bg-gray-600'}`}></div>
          ...
          {/* HEADER ACTIONS: Notification Hub added here */}
        ...
        <div className="flex-1 max-w-6xl w-full mx-auto animate-in fade-in duration-1000">
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-12">
                ...
                >
                    <div className="p-4 bg-blue-500/10 rounded-2xl w-fit mb-6 text-blue-500">
                      <Activity size={28}/>
                    </div>
...
const ProgressNode = ({ active, icon, label }) => (
  <div className="flex flex-col items-center gap-3">
    ...
    <span className={`text-[9px] font-black uppercase tracking-widest text-center w-24 ${active ? 'text-blue-500' : 'text-gray-400 dark:text-gray-600'}`}>{label}</span>
  </div>
);
